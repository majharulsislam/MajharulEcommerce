	...
	<div class="col-md-8 grid-margin stretch-card">
    	<div class="card">
	      <div class="card-body">
	        ...
	        <form action="{{ route('admin.district.update',$district->id) }}" method="post" class="forms-sample" enctype="multipart/form-data" file="true">
	        	@csrf

	          <div class="form-group">
	            <label for="title">District Name :</label>
	            <input type="text" class="form-control" name="name" id="title" value="{{ $district->name }}">
	          </div>
